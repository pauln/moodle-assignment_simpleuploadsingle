...
$url = new moodle_url('/mod/assignment/type/simpleuploadsingle/upload.php',  array('contextid'=>$contextid,
...
$instance = new assignment_simpleuploadsingle($cm->id, $assignment, $cm, $course);
...
$options = array('subdirs'=>0, 'maxbytes'=>get_max_upload_file_size($CFG->maxbytes, $course->maxbytes, $assignment->maxbytes), 'maxfiles'=>1, 'accepted_types'=>'*', 'return_types'=>FILE_INTERNAL);
    ...
    $mform = new mod_assignment_simpleuploadsingle_form(null, array('contextid'=>$contextid, 'userid'=>$formdata->userid, 'options'=>$options));
