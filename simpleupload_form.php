 ...
 */
class mod_assignment_simpleuploadsinglesimple_form extends moodleform {
    ...
    function definition() {
        ...
        // buttons
        $mform->addElement('submit', 'submitbutton', get_string('upload', 'assignment_simpleuploadsingle'));
